import { getPatient, newPatient, getAllPatients, deletePatient, updatePatient } from "./../middlewares/dbQueries";
...
router.put('/:id', async({params:{id}, body:{email,address,phone,hasCovid}},res)=>{
